...
const SortableQuestionItem: React.FC<SortableQuestionItemProps> = ({ id, children }) => {
  ...
  return (
    ...
    >
      <div
        className={cn("flex gap-2 bg-white p-3 border border-gray-200 rounded-lg", {
...
export default memo(SortableQuestionItem);
