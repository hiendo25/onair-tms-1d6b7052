...
export type DialogDeleteRoleConfirmationRef = {
  open: (
...
interface DialogDeleteRoleConfirmationProps {
  className?: string;
  isLoading?: boolean;
  onOk?: () => void;
...
const DialogDeleteRoleConfirmation = forwardRef<DialogDeleteRoleConfirmationRef, DialogDeleteRoleConfirmationProps>(
...
export default DialogDeleteRoleConfirmation;
