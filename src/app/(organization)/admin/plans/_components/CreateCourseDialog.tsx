...
export default function CreateCourseDialog({
  ...
  const onSubmit = (data: CreateCourseFormData) => {
    // Create course object without id (will be generated by parent)
    onCreateCourse({
      title: data.title,
      // Notes field is not part of Course schema, so we'll skip it for now
      // In a real implementation, you might want to extend the Course schema
    });
    reset();
    onClose();
  };
