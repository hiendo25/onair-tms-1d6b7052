...
export const getSessionMode = (sessions: ClassRoomPriorityDto["class_sessions"]) => {
...
const resolveRuntimeStatusByTime = (startAt?: string | null, endAt?: string | null): ClassRoomRuntimeStatusFilter => {
...
export const getRuntimeStatusDisplay = (startAt?: string | null, endAt?: string | null) => {
  const resolvedStatus = resolveRuntimeStatusByTime(startAt, endAt);
  const palette =
    RUNTIME_STATUS_COLOR_MAP[resolvedStatus] ?? RUNTIME_STATUS_COLOR_MAP[ClassRoomRuntimeStatusFilter.All];
