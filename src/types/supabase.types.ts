...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      class_attendances: {
        Row: {
          attendance_method: Database["public"]["Enums"]["attendance_method_enum"] | null;
          attendance_mode: Database["public"]["Enums"]["attendance_mode_enum"] | null;
      ...
      surveys_answers: {
        Row: {
          ...
          question_type: Database["public"]["Enums"]["survey_question_type"] | null;
          response_id: string;
        };
        Insert: {
          answer_value?: Json | null;
    ...
    Enums: {
      ...
      branch_status: "active" | "inactive" | "deleted";
      ...
      course_status: "published" | "pending" | "draft" | "deleted" | "unpublished";
      ...
      leaderboard_period: "daily" | "weekly" | "monthly" | "quarterly" | "yearly" | "all_time";
      ...
      survey_question_type: "checkbox" | "radio" | "text" | "rating" | "sort_rating" | "yes_no";
      survey_target_type: "class_room" | "learning_path";
      survey_type: "planning" | "classroom";
      training_plan_status: "pending" | "approved" | "rejected" | "deleted" | "pending_survey";
...
export const Constants = {
  ...
  public: {
    Enums: {
      ...
      qr_code_status: ["inactive", "active", "expired", "disabled"],
      question_difficulty: ["easy", "medium", "hard"],
      question_type: ["file", "text", "checkbox", "radio", "matching", "drag_and_drop", "true_false", "order", "fill"],
      resource_kind: ["folder", "file"],
      rule_trigger_type: [
        "lesson_completed",
        "assignment_graded",
