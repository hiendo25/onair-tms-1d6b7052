...
export const MOCK_SURVEYS: Survey[] = [
  {
    ...
    questions: [
      ...
      {
        id: "q2",
        label: "Yếu tố nào quan trọng nhất với bạn? (Chọn nhiều đáp án)",
        type: "checkbox",
        is_required: true,
        options: ["Lương thưởng", "Công việc ổn định", "Đồng nghiệp thân thiện", "Cơ hội thăng tiến", "Đào tạo & Phát triển"],
      },
      {
        id: "q3",
        label: "Đánh giá mức độ hài lòng về chính sách phúc lợi",
        type: "rating",
        is_required: true,
      },
      {
        id: "q4",
        label: "Bạn có góp ý gì để cải thiện môi trường làm việc?",
        type: "text",
        is_required: false,
      },
    ],
