...
const upsertChildDepartmentSchema = zod.object({
...
type UpsertChildDepartmentFormData = zod.infer<typeof upsertChildDepartmentSchema>;

export { upsertChildDepartmentSchema, type UpsertChildDepartmentFormData };
