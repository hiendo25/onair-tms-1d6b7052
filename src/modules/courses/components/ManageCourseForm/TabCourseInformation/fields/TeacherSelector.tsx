/**
 * Field no use after BA Update 18/11/2025
 */
...
// import { TeacherSelectedItem } from "@/modules/courses/store/upsert-course-store";
...
//   ({ className, error, helperText }, ref) => {
//     const [open, setOpen] = useState(false);
//     const setSelectedTeachers = useUpsertCourseStore(({ actions }) => actions.setSelectedTeachers);
//     const removeTeacher = useUpsertCourseStore(({ actions }) => actions.removeTeacher);
