/**
 * Split this service to 2 service create, update
 */
...
//   async create(payload: { formData: ClassRoomFormValues; students: ClassRoomStore["state"]["selectedStudents"] }) {
...
//     // await this.notificationService.createTeacherNotification({
//     //   classRoomId: classRoomData.id,
//     //   classRoomSlug: uniqueSlug,
//     //   classRoomTitle: title,
//     //   receiverEmployeeIds: [...teachersMap.values()],
