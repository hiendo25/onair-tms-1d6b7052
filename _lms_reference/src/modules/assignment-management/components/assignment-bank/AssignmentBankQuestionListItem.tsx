...
interface AssignmentBankQuestionListItemProps {
  question: QuestionBankDto;
  checked: boolean;
  onToggle: () => void;
}

const AssignmentBankQuestionListItem = ({ question, checked, onToggle }: AssignmentBankQuestionListItemProps) => {
  ...
  return (
    ...
    >
      <Checkbox checked={checked} onChange={onToggle} sx={{ alignSelf: "center", p: 0.5 }} />
      <Stack spacing={1}>
...
export default memo(AssignmentBankQuestionListItem);
